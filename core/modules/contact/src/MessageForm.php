...
class MessageForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['copy'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('<p>Tôi đồng ý với <a href="#" style="color: #F57658">Chính sách bảo mật</a> và <br> <span style="margin-left: 20px;"><a href="#" style="color: #F57658">Điều khoản dịch vụ</a> của MEE Solutions.</span></p>'),
  ...
  public function actions(array $form, FormStateInterface $form_state) {
    ...
    $elements['submit']['#value'] = $this->t('GỬI TIN NHẮN');
    $elements['preview'] = [
      '#type' => 'submit',
