...
if(!class_exists('gsc_box_text_customize')):
   class gsc_box_text_customize{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_text_customize',
            'title'        => t('Box Text Customize'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
               array(
      ...
      public static function sc_box_text( $attr, $content = null ){
         ...
         <div class="gsc-box-text widget clearfix <?php print $el_class; ?>" <?php print $style; ?>>
            <?php if($title){ ?>
               <div class="title widget-title title-service" <?php print $style_title; ?>>
