...
if(!class_exists('gsc_box_image_content')):
   class gsc_box_image_content{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_image_content',
            'title'        => t('Box Image content'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
      ...
      public static function sc_image_content( $attr, $content = null ){
         ...
         <div class="gsc-image-content <?php print $el_class; ?>">
            <div class="row" style="box-shadow: 1px 1px 5px #d8d8d8; margin-left: -0px; margin-right: -0px;">
               <div class="customize-image">
                  <div class="content col-sm-6 box-image-1">  
                     <div class="desc" style="float: left; color: white;"><?php print $content; ?></div>
                     <?php if($link){ ?>
                        <div class="action" ><a <?php print $target ?> href="<?php print $link ?>"><?php print t('Read more') ?></a></div>
                     <?php } ?>  
                  </div>  
                  <div class="content col-sm-6 box-image-1" style="padding-left: 0px; padding-right: 0px;">
                     <?php if($background){ ?>
                        <img style="float: left;  width: 100%; height: 100%;" src="<?php print $background ?>" />
                     <?php } ?>
                  </div>
               </div>
            </div>
