   ...
   class gsc_image_content{
      ...
      public static function sc_image_content( $attr, $content = null ){
         ...
         <div class="gsc-image-content <?php print $el_class; ?>">
            <div class="content">
               <?php if($title){ ?><?php if($link){ ?><a <?php print $target ?> href="<?php print $link ?>"><?php } ?><img style="float: left;" src="<?php print $background ?>" alt="<?php print $title ?>" /><?php if($link){ ?></a><?php } ?><h4 class="title" style="float: left;"><?php print $title ?></h4><?php } ?>   
               <div class="desc" style="float: left;"><?php print $content; ?></div>
               <?php if($link){ ?>
