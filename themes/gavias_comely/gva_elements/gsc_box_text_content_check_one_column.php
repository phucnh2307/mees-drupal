...
if(!class_exists('gsc_box_text_content_check_one_column')):
   class gsc_box_text_content_check_one_column{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_text_content_check_one_column',
            'title'        => t('Box Text Content Check One'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
               array(
            ...
            <?php if($title_left){ ?>
               <div class="row">
                  <div class="title widget-title" <?php print $style_title; ?>>
                     <img src="<?php $base_url ?>/sites/default/files/gbb-uploads/customize_mees/checks.png" alt="">
                     <?php if($link){ ?> <a href="<?php print $link ?>" <?php print $target ?>> <?php } ?> <?php print $title_left ?> <?php if($link){ ?> </a><?php } ?>
                  </div>
               </div>
               <hr style="margin-top: 10px; margin-bottom: 10px; border-top: none !important;">
            <?php } ?>
            <?php if($content){ ?>  
