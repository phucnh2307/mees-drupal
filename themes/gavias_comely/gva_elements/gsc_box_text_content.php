...
if(!class_exists('gsc_box_text_content')):
   class gsc_box_text_content{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_text_content',
            'title'        => t('Box Text Content'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
               array(
         ...
         <div class="gsc-box-text widget clearfix <?php print $el_class; ?>" <?php print $style; ?>>
            <?php if($title_left){ ?>
               <div class="row">
                  ...
                  <div class="title widget-title col-sm-6" <?php print $style_title; ?>>
                     <img src="<?php $base_url ?>/sites/default/files/gbb-uploads/customize_mees/check.png">
