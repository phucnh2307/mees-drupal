...
if(!class_exists('gsc_box_text_title')):
   class gsc_box_text_title{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_text_title',
            'title'        => t('Text Title'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
      ...
      public static function sc_box_text( $attr, $content = null ){
         ...
         <div class="widget clearfix <?php print $el_class; ?>" <?php print $style; ?>>
            <?php if($title_left){ ?>
               <div class="row">
                  <div class="title widget-title" style="font-size: 40px; color: #4BAFEA;" <?php print $style_title; ?>>
                     <?php if($link){ ?> <a href="<?php print $link ?>" <?php print $target ?>> <?php } ?> <?php print $title_left ?> <?php if($link){ ?> </a><?php } ?>
                  </div>
                  <div class="title widget-title" style="font-size: 40px; font-weight: bold; color: #FF6A47;" <?php print $style_title; ?>>
