...
if(!class_exists('gsc_box_text_customize_border_left')):
   class gsc_box_text_customize_border_left{
      public function render_form(){
         return array(
           'type'          => 'gsc_box_text_customize_border_left',
            'title'        => t('Box Text Customize Border Left'),
            'size'         => 3,
            'icon'         => 'fa fa-bars',
            'fields' => array(
               array(
      ...
      public static function sc_box_text( $attr, $content = null ){
         ...
         <div class="gsc-box-text widget clearfix border-left-service <?php print $el_class; ?>" <?php print $style; ?> style="margin-top: 20px;">
            <?php if($title){ ?>
               <div style="margin-left: 20px;">
                  <div class="title widget-title title-service-border" <?php print $style_title; ?>>
